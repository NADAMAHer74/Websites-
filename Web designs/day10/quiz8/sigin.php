              ...
              <div class="card shadow-2-strong" style="border-radius: 1rem;">
                <div class="card-body p-5 text-center">
                  ...
                  <div    class="form-outline mb-4">
                    ...
                    <input type="email" id="typeEmailX-2" class="form-control form-control-lg"   value="<?php echo $email; ?>" />
                  ...
                  <button class="btn btn-primary btn-lg btn-block" type="submit"  name="reg_user">Signup</button>
                  <p>Already have an account? <a href="quiz8.html">Login</a></p>
